...
class TestCredential(unittest.TestCase):
    def setUp(self):
        ...
        self.new_credential = Credential("steve","ongati","123456","ongati@gmail.com") # create Account object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credential.usr_name,"ongati")
        self.assertEqual(self.new_credential.password,"123456")
        self.assertEqual(self.new_credential.email,"ongati@gmail.com")
